...
import { AlertTriangle, ChevronDown, TrendingUp, Activity, Package, Lock } from "lucide-react";
...
const ALL_OPTIONS = [
  { id: "low-stock",  permissionName: "Low Stock Alert",     label: "Low Stock Alert",     icon: AlertTriangle, description: "Monitor items below threshold",  color: "text-red-600" },
  { id: "turnover",   permissionName: "Inventory Turnover",  label: "Inventory Turnover",  icon: TrendingUp,    description: "Calculate turnover ratio",        color: "text-blue-600" },
  { id: "valuation",  permissionName: "Inventory Valuation", label: "Inventory Valuation", icon: Activity,      description: "View total inventory value",      color: "text-green-600" },
];
...
export default function InventoryReportWrapper() {
          ...
          <div className="flex flex-wrap items-start justify-between gap-4">
            <div className="flex items-center gap-3 min-w-0 flex-1">
              ...
              <div className="min-w-0">
                <h1 className="text-lg sm:text-xl font-bold text-gray-900 truncate">Inventory Reports</h1>
                <p className="text-xs sm:text-sm text-gray-500 truncate">Analyze stock levels, turnover, and valuation</p>
              </div>
            </div>
